...
/* package */ final class PlayerManager implements AdsMediaSource.MediaSourceFactory {
  ...
  //  MediaSource contentMediaSource = buildMediaSource(Uri.parse(contentUrl));
    MediaSource contentMediaSource = new ExtractorMediaSource.Factory(mediaDataSourceFactory).createMediaSource(Uri.parse(contentUrl));
  ...
  private MediaSource buildMediaSource(Uri uri) {
    ...
    switch (type) {
      ...
      default:
        Log.d("TAG","Unsupported type "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
