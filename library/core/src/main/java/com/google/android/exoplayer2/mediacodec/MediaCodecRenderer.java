...
public abstract class MediaCodecRenderer extends BaseRenderer {
  ...
  public MediaCodecRenderer(int trackType, MediaCodecSelector mediaCodecSelector,
    ...
    super(trackType);
    Log.d("TAG","KMI!!!!!!!!!  MediaCodecRenderer start "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
  ...
  protected final void maybeInitCodec() throws ExoPlaybackException {
    ...
    Log.d("TAG","KMI!!!!!!!!! mimeType = " + mimeType +new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
    ...
    if (MimeTypes.isAudio(mimeType)) {
      ...
      Log.d("TAG","KMI!!!!!!!!!  log.setModule(Logger.Module.Video)  "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
...
//    Log.d("TAG","KMI!!!!!!!!! render render!!! "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
    ...
    if (format == null) {
      // We don't have a format yet, so try and read one.0
      Log.d("TAG","KMI!!!!!!!!! We don't have a format yet, so try and read one.0 "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
    ...
    maybeInitCodec();
    if (codec != null) {
  //    Log.d("TAG","KMI!!!!!!!!! codec != null "+new Throwable().getStackTrace()[0].getMethodName()+"()"+"#"+new Throwable().getStackTrace()[0].getLineNumber());
